    ...
    return (
        <View style={Styles.container}>
            ...
            <View style={Styles.bottomRow}>
                <Ionicons.Button style={Styles.button} name={seeingFace ? 'arrow-forward-circle' : 'hand-left'} color={!seeingFace ? 'red' : 'black'} onPress={() => {
                    //@ts-ignore
                    navigation.replace('Camera');
                }} disabled={!seeingFace}>
                    {seeingFace ? 'Begin Recording' : 'Please Show Your Face to Begin Recording'}
                </Ionicons.Button>
            </View>
        </View>
